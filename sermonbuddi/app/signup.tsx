                ...
                <View style={[styles.container, { backgroundColor: colors.background }]}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false}>
                        <View style={styles.titleContainer}>
                            <Text style={[styles.title, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>Join</Text>
                            <Text style={[styles.title, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>SermonBuddi</Text>
                        </View>
                        <Input
                            id="firstName"
